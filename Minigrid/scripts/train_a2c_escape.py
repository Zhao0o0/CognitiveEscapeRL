...
def tuner(icm_lr, reward_weighting, normalise_rewards, args):
    ...
    from .a2c_escape import A2CAlgo
    ...
    for i in range(16):   #16
        ...
        #print('train.py:95line',an_env.observation_space)     #
        envs.append(an_env)
    ...
    #print('train_110line: obs_space',obs_space)    #{'image': (7, 7, 3), 'text': 100}
    #print(envs[0].observation_space)   #95line Dict('direction': Discrete(4), 'image': Box(0, 255, (7, 7, 3), uint8), 'mission': MissionSpace(<function MultiRoom              Env.__init__.<locals>.<lambda> at 0x7f1d3cd838c0>, None))
    ...
    # Load model
    print('train_113line:type(envs[0])',type(envs[0]))
    ...
    if "optimizer_state" in status:
        print('train.py:196 line')
        algo.optimizer.load_state_dict(status["optimizer_state"])
    print('train.py:198 line')

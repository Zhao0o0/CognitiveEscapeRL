...
def tuner(icm_lr, reward_weighting, normalise_rewards, args):
    ...
    #print(envs[0].observation_space)   #Dict('image': Box(0, 255, (7, 7, 3), uint8))
    if "vocab" in status:
    ...
    #print('train_113line:args.mem',args.mem)    #False
    #print(acmodel.recurrent)    #True 后续代码不影响
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--procs", type=int, default=1, help="number of processes (default: 128)"
    )    #
    parser.add_argument(
        "--frames",
        type=int,
